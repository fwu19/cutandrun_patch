...
qc <- 'aligned_pct' 
funcs[[qc]] <- function(df, tgt, var.x = 'target_alignment_rate', var.y = 'sample_group', xlab = 'Fraction of reads aligned to the target genome', ylab = '', color = 'Replicate', plot.title = 'Alignment rate to target genome'){
  require(ggplot2)
...
funcs[[qc]] <- function(df, tgt, var.x = 'bt2_total_aligned_spikein', var.y = 'sample_group', xlab = 'Total aligned reads (in thousand) to the spike-in genome', ylab = '', color = 'Replicate', plot.title = 'Reads aligned to spike-in genome'){
  require(ggplot2)
...
## Fragment length ####
funcs[['frag_lens_dens']] <- function(df, tgt, var.x = 'length', var.y = 'count', var.group = 'sample_id', facet.row = 'sample_group', xlab = 'Fragment length (bp)', ylab = 'Occurrences', color = 'Replicate', plot.title = 'Fragment length'){
  require(ggplot2)
